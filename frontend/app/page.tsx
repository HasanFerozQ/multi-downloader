...
const ANALYZER_FAQ = [
  {
    q: "Which platforms can I analyze?",
    a: "The Video Analyzer supports YouTube, TikTok, Instagram, Facebook, and X (Twitter). Paste any public video URL from these platforms to get a full 31-metric analysis.",
  },
  {
    q: "What are the 5 master scores?",
    a: "Click Potential (will people click?), SEO Strength (will it be found?), Retention (will they watch?), Viral Probability (can it go viral?), and Technical Quality (is it optimized?). Each is a composite of multiple sub-metrics scored 0–100.",
  },
  {
    q: "How is the Overall Score calculated?",
    a: "The Overall Score is a weighted average of the 5 master scores, with Click Potential and SEO weighted slightly higher. Scores are adjusted upward for videos already performing strongly in the real world (viral/high-engagement videos).",
  },
  {
    q: "What is VPH (Views Per Hour)?",
    a: "VPH is the average number of views the video receives per hour since it was published. It's a real-time velocity metric — VPH over 1,000 indicates viral momentum; VPH over 100 indicates strong algorithmic push.",
  },
  {
    q: "Why does analysis take up to 30 seconds?",
    a: "The analyzer fetches live metadata from the platform, then runs 31 algorithms simultaneously across scoring dimensions. Platform API responses can vary in latency — TikTok and Instagram typically respond faster than YouTube.",
  },
  {
    q: "Can I analyze private or unlisted videos?",
    a: "No — only public videos can be analyzed. Private, unlisted, members-only, and age-restricted videos without cookie authentication cannot be fetched.",
  },
  {
    q: "What does the 'Reality Check' section mean?",
    a: "Some videos break conventional optimization rules but still perform extremely well. The Reality Check detects these cases and boosts the score to better reflect real-world performance, noting which signals triggered the override.",
  },
  {
    q: "What are Retention Risks?",
    a: "Retention Risks are specific issues detected in your video metadata that correlate with early viewer drop-off — such as a weak hook, poor pacing signals, or a description that doesn't set expectations. Each risk comes with a tip to address it.",
  },
];
...
export default function VideoAnalyzerPage() {
  ...
  return (
    <>
      ...
      {/* FAQ */}
      <FAQSection items={ANALYZER_FAQ} title="Video Analyzer — FAQ" />
    </>
  );
}
